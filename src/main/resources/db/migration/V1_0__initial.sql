...
CREATE INDEX IDX_9234925671F7E88B ON comment_event (event_id);
CREATE INDEX IDX_92349256F8697D13 ON comment_event (comment_id);
...
CREATE INDEX IDX_3BE53BBCB5A459A0 ON comment_news (news_id);
CREATE INDEX IDX_3BE53BBCF8697D13 ON comment_news (comment_id);
...
CREATE INDEX IDX_BEA313BEA76ED395 ON claims (user_id);
CREATE INDEX IDX_BEA313BEF8697D13 ON claims (comment_id);
CREATE INDEX IDX_BEA313BE54B763AD ON claims (claim_type_id);
...
CREATE INDEX IDX_BD2D1CE9F8697D13 ON comment_photo (comment_id);
CREATE UNIQUE INDEX UNIQ_BD2D1CE97E9E4C8C ON comment_photo (photo_id);
CREATE TABLE videos
(
    id            SERIAL,
...
ALTER TABLE comment_event
    ADD CONSTRAINT FK_9234925671F7E88B FOREIGN KEY (event_id) REFERENCES events (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE comment_event
    ADD CONSTRAINT FK_92349256F8697D13 FOREIGN KEY (comment_id) REFERENCES comments (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE news
...
ALTER TABLE comment_news
    ADD CONSTRAINT FK_3BE53BBCB5A459A0 FOREIGN KEY (news_id) REFERENCES news (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE comment_news
    ADD CONSTRAINT FK_3BE53BBCF8697D13 FOREIGN KEY (comment_id) REFERENCES comments (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE claims
    ADD CONSTRAINT FK_BEA313BEA76ED395 FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE claims
    ADD CONSTRAINT FK_BEA313BEF8697D13 FOREIGN KEY (comment_id) REFERENCES comments (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE claims
    ADD CONSTRAINT FK_BEA313BE54B763AD FOREIGN KEY (claim_type_id) REFERENCES claim_types (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE comments
    ADD CONSTRAINT FK_5F9E962AA76ED395 FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE comment_photo
    ADD CONSTRAINT FK_BD2D1CE9F8697D13 FOREIGN KEY (comment_id) REFERENCES comments (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE comment_photo
    ADD CONSTRAINT FK_BD2D1CE97E9E4C8C FOREIGN KEY (photo_id) REFERENCES photos (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE videos
